...
\begin{frame}{Strukturierung}
	\begin{itemize}
		\item Aufgabe % Thema, Motivation (Akku effizient nutzen) - Sebastian
		\item Algorithmen % Idee, Funktionsweise, Anwendungsfälle (Eignung), Probleme
		\begin{itemize}
		...
		\end{itemize}
		\item Testing \& Bewertung % Diagramme, Bewertung der Ergebnisse (Rating), Einordnung der Algorithmen - Can
